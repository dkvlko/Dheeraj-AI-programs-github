...
FINPUT_JSON = Path("/home/dkvlko/Dheeraj-AI-programs-github/"
        "liv_code/SandasUrineServer/app/modules/newsanddays/data/sortednews.json")

Common_Json = Path(
        "/home/dkvlko/Dheeraj-AI-programs-github/"
        "liv_code/SandasUrineServer/app/modules/newsanddays/data/common.json"
     )   
...
def combine_rss_files(rss_files):
    ...
    output_file = Path("/home/dkvlko/Dheeraj-AI-programs-github/liv_code/SandasUrineServer/app/modules/newsanddays//data/common.rss")
...
def main():
    ...
    utility_dedupl.deduplication()
    #print("Deduplication Finished")
    utility_ranksort.sortjsonbyrank()
