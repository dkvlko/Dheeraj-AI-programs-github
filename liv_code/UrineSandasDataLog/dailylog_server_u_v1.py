import os
import sqlite3
from flask import Flask, render_template, request, send_from_directory, abort, send_file, make_response
from datetime import datetime, timedelta


#source flask_env/bin/activate -activate flask first
...
TEMPLATE_FOLDER = "/home/dheeraj/OneDrive/DheerajOnHP/liv_code/UrineSandasDataLog/web"
FILES_FOLDER = os.path.join(TEMPLATE_FOLDER, "FILES")

app = Flask(__name__, template_folder=TEMPLATE_FOLDER)

ALLOWED_EXTENSIONS = {".mp3", ".mp4",".m4b",".m4a",".zip"}
...
if __name__ == "__main__":
    ...
    #app.run(host='192.168.29.25', port=8000, ssl_context=context, debug=True)