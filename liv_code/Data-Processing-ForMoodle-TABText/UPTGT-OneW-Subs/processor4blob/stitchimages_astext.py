...
def main():
    ...
    input_path = "/home/dkvlko/Dheeraj-AI-programs-github/liv_code/BLOBS/Priyanka-One-Word-Substitute"
    ...
    # Output file path
    combined_file_path = OUTPUT_DIR / "OWSubstitute_Combined.txt"
