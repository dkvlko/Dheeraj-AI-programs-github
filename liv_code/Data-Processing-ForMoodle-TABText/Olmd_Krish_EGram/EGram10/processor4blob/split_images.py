#!/usr/bin/env python3
"""
Image Splitter for IEO 10 PDF Book Processing
...
def main():
    ...
    input_path="/home/dkvlko/Dheeraj-AI-programs-github/liv_code/BLOBS/Krish_EGram10"


    # One level up
    UINPUT_DIR = Path(input_path)
    INPUT_DIR = UINPUT_DIR / "REMWATERM"
    IMAGE_DIR = INPUT_DIR 

    # OUTPUT_DIR = INPUT_DIR/SPLIT
    OUTPUT_DIR = UINPUT_DIR / "SPLIT"
    ...
    images = sorted(
        IMAGE_DIR.glob("class_10_ieo_1*.png")
    )
