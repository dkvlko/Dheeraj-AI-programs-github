...
def main():
    ...
    TEXT_DIR = Path("/home/dkvlko/Dheeraj-AI-programs-github/liv_code/BLOBS/Krish_EGram10/SPLIT/COMBINED_TEXT")  

    INPUT_FILE = TEXT_DIR / "Olymp_10_EGram_full_up3_merged_up1_answers_replaced.txt"
    OUTPUT_FILE = TEXT_DIR / "Olymp_10_EGram_full_moodle.txt"
