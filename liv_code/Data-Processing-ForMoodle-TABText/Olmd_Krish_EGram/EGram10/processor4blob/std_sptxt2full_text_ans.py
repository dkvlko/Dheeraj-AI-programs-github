#!/usr/bin/env python3
"""
Combine OCR Text Files for Olympiad  Book
...
def main():
    ...
    input_path="/home/dkvlko/Dheeraj-AI-programs-github/liv_code/BLOBS/Krish_EGram10/SPLIT"

    INPUT_DIR = Path(input_path)

    # Source directory
    TEXT_DIR = INPUT_DIR / "IMG_2_TEXT"

    # Output directory
    OUTPUT_DIR = INPUT_DIR / "COMBINED_TEXT"
    ...
    if not TEXT_DIR.exists():
        print("IMG_2_TEXT directory does not exist.")
        sys.exit(1)

    # Load all matching txt files and sort them by name
    text_files = sorted(
        TEXT_DIR.glob("class_10_ieo_ans1*.txt")
    )
    ...
    # Output file path
    combined_file_path = OUTPUT_DIR / "Olymp_10_EGram_full_ans.txt"
