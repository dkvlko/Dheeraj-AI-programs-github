...
def main():
    ...
    TEXT_DIR = Path("/home/dkvlko/Dheeraj-Cloud-Drives/DheerajOnHP/BLOBS/Krish_Maths4/pdfimgs/COMBINED_TEXT")  

    INPUT_FILE = TEXT_DIR / "OlympiadMaths_Set1_up4.txt"
    OUTPUT_FILE = TEXT_DIR / "OlympiadMaths_Set1_mood.txt"
