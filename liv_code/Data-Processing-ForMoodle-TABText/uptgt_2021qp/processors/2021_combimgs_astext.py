...
def main():
    ...
    SCRIPT_DIR = Path("/home/dkvlko/Dheeraj-Cloud-Drives/DheerajOnHP/BLOBS/Prka_PQ2021")
    ...
    # Output directory
    OUTPUT_DIR = INPUT_DIR / "COMB_TEXT"
    ...
    # Output file path
    combined_file_path = OUTPUT_DIR / "UPTGT2021-Combined_Text.txt"
